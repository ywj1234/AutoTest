...
public class MyGetMethod {
    ...
    @ApiOperation(value = "开发一个需要携带参数才能访问的get请求  方式1",httpMethod = "GET")
    ...
    @ApiOperation(value = "开发一个需要携带参数才能访问的get请求  方式2",httpMethod = "GET")
